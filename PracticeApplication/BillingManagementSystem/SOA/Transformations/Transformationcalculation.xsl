   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            <oracle-xsl-mapper:schema location="oramds:/apps/BillingSystem/WSDLs/BSBPELProcess.wsdl"/>
            <oracle-xsl-mapper:rootElement name="bsRequest" namespace="http://xmlns.oracle.com/PracticeApplication/BillingManagementSystem/BSBPELProcess"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="WSDL">
            <oracle-xsl-mapper:schema location="oramds:/apps/BillingSystem/WSDLs/BSBPELProcess.wsdl"/>
            <oracle-xsl-mapper:rootElement name="bsResponse" namespace="http://xmlns.oracle.com/PracticeApplication/BillingManagementSystem/BSBPELProcess"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.4.0(XSLT Build 190828.0353.3300) AT [MON NOV 13 18:31:05 IST 2023].-->
   </oracle-xsl-mapper:schema>
